...
function MapMarker() {
  ...
  const map = useMapEvent('click', (e) => {
    ...
    // Set Endpoint function
      ...
      // Tthe Buttons text will switch to "Startpoint"
      // The button will always display the active Marker
      document.getElementById("buttonMarker").innerHTML = "Startpoint";
    }
  });
    ...
    render() {
        return (
            <div>
              <div class="divButton">
                Active:<br></br>
                <button id="buttonMarker" class="markerButtons" onClick={setMarkerStart}>Startpoint</button>
              </div>
